...
class IATF_Runner:
    ...
    def __init__(self,
        ...
        self.LOCATION_SPECIES_SINGLE_VALUE = 'single_value'
        self.LOCATION_SPECIES_RING = 'ring'
    ...
    def run_it(self):
        ...
        for i in range(self.iters):
            self.IATF.compute_next(self.driver_list[i], location = self.location, custom_update=self.custom_update)
            ...
            if self.location_species == self.LOCATION_SPECIES_RING:
                self.location = self.IATF.index
